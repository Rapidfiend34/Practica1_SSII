...
public class Agente {
    ...
    public void SubirPiso() {
        ...
        if ((this.a < this.Pisos - 1) && (this.b[a] == 0) && (this.c[a] == 0) && (!this.d)
            ...
            this.state = false; // En caso de no poder cedemos el estado a bajada
            // para así verificar si no podiamos subir por dicha booleana o por otra
            // condición, asi no damos prioridasd ni a la subida ni a la bajada
        }
        try {
            Thread.sleep(1000);
        } catch (InterruptedException e) {
    ...
    public void BajarPiso() {
        ...
        if ((this.a > 0) && (!this.d) && (this.b[a] == 0) && (this.c[a] == 0)
            ...
            this.state = true; // Cedemos el estado a la subida para así verificar que no es posible debidio a
                               // otra condicion
        }
        try {
            Thread.sleep(1000);
